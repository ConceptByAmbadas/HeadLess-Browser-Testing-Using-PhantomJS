...
public class Utility {
	...
	public static String takeScreenshot(WebDriver driver) {
		try {
			...
			dest = "E:\\StudyWorkpace\\PhantomJS\\Screenshot\\" + time + ".png"; 
	...
	public WebDriver startBrowser(String browsername,String url)
	{
		...
		{
			File src=new File("E:\\StudyWorkpace\\PhantomJS\\PhantomJS_jars\\phantomjs-2.1.1-windows\\bin\\phantomjs.exe");
	...
	public void Reportsetup()
	{
		try
		{
			...
			report=new ExtentReports("E://StudyWorkpace//PhantomJS//ExtentReport//Report.html",true);
			...
			.addSystemInfo("Project Name", "Customer Registration");
